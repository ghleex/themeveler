<template>
  <div id="service-create">
    <div class="service-center-title">
      <i class="far fa-sticky-note mr-3"></i>고객센터 작성</div>

    <div class="service-body">
      <div class="reset">
        <v-btn color="error" class="btn-create text-light" @click="reset"><i class="fas fa-redo-alt mr-1"></i>다시 작성
        </v-btn>
      </div>
      <v-form ref="form" class="service-create-form" v-model="valid" lazy-validation>
        ...
        <!-- <v-text-field color="#607D8B" v-model="content" :rules="contentRules" label="내용" required>
       </v-text-field> -->
        <v-textarea color="#607D8B" class="mt-4"
          outlined
          label="내용"
