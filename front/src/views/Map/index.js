...
const DAUM_KAKAO_MAP_LIB_URL = `//dapi.kakao.com/v2/maps/sdk.js?appkey=${KAKAO_API_KEY}&libraries=drawing,clusterer,services&autoload=false`
  ...
  async mount (elementId) {
    ...
    // create map
      ...
      this.map = new Map.daum.maps.Map(
        document.getElementById(elementId), // mapContainer
        { // mapOption
          center: new Map.daum.maps.LatLng(35.65919598808177, 127.73894402702498), // 지도의 중심좌표
          level: 13, // 지도의 확대 레벨
        },
      )
