<template>
  ...
  <v-toolbar color="rgba(255, 255, 255, 0.85)" class="search-box">
    ...
    <v-autocomplete color="#4DD0E1" v-model="select" :loading="loading" :items="items" :search-input.sync="search" cache-items
      class="mx-4" flat hide-no-data hide-details label="Where do you want to go?" solo-inverted></v-autocomplete>
    <!-- <v-btn icon> -->
